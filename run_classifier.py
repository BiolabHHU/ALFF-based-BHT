...
def train_step(images, labels):
    ...
    gradient_e = encode_tape.gradient(loss2, encoder.trainable_variables)
...
def train_h0(train_data, train_label, print_information=False):
    for epoch_count in range(EPOCH):
        ...
        loss2, predicted_label = train_step(images=train_x, labels=label_x)
        ...
        if print_information:
            ...
            print(template2.format(epoch_count, loss2, train_accuracy.result() * 100))
...
def train():
    ...
    scio.savemat('./save_model/pre_lab/{}/pre_lab_{}.mat'.format(name_of_data, j_out), {'pre_lab': pred_tyb})
