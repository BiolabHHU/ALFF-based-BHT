...
function [train_h0_data, train_h0_label, train_h1_data, train_h1_label, test_h0_label, test_h1_label, rank_h0, rank_h1]=svm_two_suppose_ALFF(index, data_name)
...
X_temp = alff(:,[21:22, 29:42, 71:78, 91:116]);                 % FC上三角矩阵
% X_temp = alff;
Y_temp = lab;
...
[train_h0_data, train_h0_label, test_h0_label, rank_h0] = train_h0(index, X, Y, selection_method, Y_temp);

[train_h0_data, train_h0_label] = energy_normalization(train_h0_data, train_h0_label);

[train_h1_data, train_h1_label, test_h1_label, rank_h1] = train_h1(index, X, Y, selection_method, Y_temp);
